...
def pdf_to_jpg(pdf_path, jpg_path, top_left, bottom_right, page_number, field_name):
    try:
        ...
        pil_image = pil_image.crop((top_left[0], top_left[1], bottom_right[0], bottom_right[1]))
        # jpg_page_path = os.path.join(jpg_path, f"page_{page_number}_{top_left[0]}_{top_left[1]}_{bottom_right[0]}_{bottom_right[1]}.jpg")
...
if __name__ == "__main__":
    ...
    parser.add_argument("x1", help="x coordinate of top-left corner", type=int)
    parser.add_argument("y1", help="y coordinate of top-left corner", type=int)
    parser.add_argument("x2", help="x coordinate of bottom-right corner", type=int)
    parser.add_argument("y2", help="y coordinate of bottom-right corner", type=int)
    ...
    result = pdf_to_jpg(args.pdf_path, args.jpg_path, top_left, bottom_right, args.page_number, args.field_name)
