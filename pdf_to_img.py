...
def pdf_to_jpg(pdf_path, jpg_path, top_right, bottom_left, page_number):
    try:
        img_list = convert_from_path(pdf_path, 500) # This returns a list even for a 1 page pdf
...
if __name__ == "__main__":
    ...
    result = pdf_to_jpg(args.pdf_path, args.jpg_path, top_right, bottom_left, args.page_number)
